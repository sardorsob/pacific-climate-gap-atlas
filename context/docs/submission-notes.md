...
- Use at least one official dataset.
- List all data sources.
- Public interactive URL must remain accessible until at least 31 August 2029.
- English or French is required for the dataviz and explanations.
- AI-assisted work must not replace the core creative or analytical process.
